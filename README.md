...
`compose.yml` pins `ghcr.io/arieltl/invoice:0.4.1` by default. Set `INVOICE_IMAGE_TAG` to the desired published version when upgrading, and back up your data first. While the repository/image is private, pulling may require GHCR access.
