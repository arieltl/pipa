...
- Commercial invoice creation for multiple clients, including recurring items
  and per-client numbering.
...
- Revisioned PDF templates, with optional HTML/Liquid rendering through
  Gotenberg.
...
- A built-in template text editor for creating and maintaining reusable
  template text, improving the current basic editor experience.
